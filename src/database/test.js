...
Database.then(async (db) => {
    ...
    proffyValue = {
        ...
        whatsapp: "13 99164-1088",
        bio:"Entusiasta das melhores tecnologias de química avançada. Apaixonado por explodir coisas em laborátorio e por mudar a vida das pessoas através de experiências. Mais de 200.00 já passaram por uma das minhas explosões",
    }
